...
$Self->{'Frontend::Module'}->{'AgentDemoOTRS'} =  {
  'Description' => 'DemoOTRS.',
  'Group' => [
    'users'
  ],
  'GroupRo' => [],
...
$Self->{'Frontend::Navigation'}->{'AgentDemoOTRS'}->{'002-DemoOTRS'} =  [
  {
    'AccessKey' => 'Currently at HEREIAM',
    'Block' => 'ItemArea',
    'Description' => 'Currently at HEREIAM',
    'Group' => [
      'users'
    ],
    'GroupRo' => [],
  ...
  },
  {
    ...
    'Group' => [],
    'GroupRo' => [],
    'Link' => 'Action=AdminGenericAgent;Subaction=Run;Profile=TOLINK;ChallengeToken=dYCUb0fj2OlNskvdnZM30B7uD2TIYLXa;',
    'LinkOption' => '',
    'Name' => 'Load RUNTO',
    'NavBar' => 'DemoOTRS',
    'Prio' => '900',
...
delete $Self->{'Frontend::ToolBarModule'}->{'110-Ticket::AgentTicketQueue'};
delete $Self->{'Frontend::ToolBarModule'}->{'120-Ticket::AgentTicketStatus'};
delete $Self->{'Frontend::ToolBarModule'}->{'130-Ticket::AgentTicketEscalation'};
...
$Self->{'Loader::Module::AgentDemoOTRS'}->{'002-DemoOTRS'} =  {
  'CSS' => [],
  'JavaScript' => []
};
...
delete $Self->{'SendmailModule::AuthPassword'};
delete $Self->{'SendmailModule::AuthUser'};
...
delete $Self->{'Ticket::TicketDynamicFieldDefault'}->{'Element1'};
delete $Self->{'Ticket::TicketDynamicFieldDefault'}->{'Element2'};
$Self->{'Ticket::Type'} =  0;
